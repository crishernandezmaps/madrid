...
El siguiente concepto busca la creación de una herramienta que permita aglutinar los productos de información resultantes desde datos abiertos, a través de la creación de un botón de compartir contenido en un repositorio público de código, imágenes y texto.

Por ejemplo, si he producido una visualización de datos sobre la localización de escuelas y su relación con las ciclovías en la Ciudad, y la he realizado utilizando librerías javascript como D3 y Leaflet, a través de esta aplicación podría en simples pasos subir mi código y las imágenes resultantes al repositorio público de la Ciudad. De la misma forma si he escrito un artículo con un fenómeno que he descubierto a través de datos abiertos.
