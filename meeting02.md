Meeting 02: 'Establecer Alcances de la propuesta a ser presentada en Visualizar16'.

Asistentes: Miguel - Cris.
2016-07-24
...
- Identificar fuentes de datos (Miguel).
- Propuesta de herramientas para la visualización de datos (Cris).
- Considerar un técnico que pueda montar una app sencilla en *Android* en la actividad en Madrid (Patricio?).
- Comenzar la escritura y confeción de la propuesta y el poster. 

**AVISO:** nos reuniremos nuevamente con Miguel el próximo Miércoles 27 de Julio via Skype en horario por definir para seguir avanzando. 